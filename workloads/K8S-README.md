...
```
$ docker image tag gateway kidscare8playground/gateway
$ docker push kidscare8playground/gateway
```
...
```
$ kubectl get svc gateway -n fairenough
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n fairenough
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n fairenough
```
...
```
$ kubectl get svc jhipster-prometheus -n fairenough
```
...
```
$ kubectl get svc jhipster-grafana -n fairenough
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n fairenough
```

and explore the details using

```
$ kubectl get svc exposed-registry -n fairenough
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n fairenough
```
